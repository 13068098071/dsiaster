...
export default {
  ...
  methods:{
     ...
     */
    async publish(id){
      request.put("/out-stock/publish/"+id).then(res => {
        console.log(res);
        if (res.code != 200) {
    ...
    async detail(id) {
      this.detailId=id;
      request.get("/out-stock/detail/"+id).then(res => {
        console.log(res);
        if (res.code != 200) {
     ...
     */
    async back(id){
      request.put("/out-stock/back/"+id).then(res => {
        if (res.code != 200) {
     ...
     */
    async remove(id) {
      request.put("/out-stock/remove/"+id).then(res => {
        if (res.code != 200) {
     ...
     */
    async loadTableData() {
      request.get("/out-stock/findOutStockList",{
     ...
     */
    async del(id) {
      request.get("/out-stock/delete/"+id).then(res => {
        if (res.code != 200) {
